...
class Methods(unittest.TestCase):
    ...
    def test_ltf(self):
        ...
        self.assertEqual(list(df.columns), ['low', 'high', 'open', 'close', 'volume'])
        self.assertEqual((df.index[1]-df.index[0]).total_seconds(), 28800)
    ...
    def test_htf(self):
        ...
        self.assertEqual(list(df.columns), ['low', 'high', 'open', 'close', 'volume'])
        self.assertEqual((df.index[1]-df.index[0]).total_seconds(), 172800)
